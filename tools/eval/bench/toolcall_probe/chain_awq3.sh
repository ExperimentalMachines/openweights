...
run w2a03 AWQ_ALPHA=0.3 AWQ_W13=0 AWQ_CONV=0
run w2a02 AWQ_ALPHA=0.2 AWQ_W13=0 AWQ_CONV=0
run w2ca03 AWQ_ALPHA=0.3 AWQ_W13=0
run alla02 AWQ_ALPHA=0.2
echo DONE > $S/awq3_done.txt
